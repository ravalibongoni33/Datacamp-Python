...
#------create list with different ypes----#
...
Y#ou managed to get hold of the changes in height, weight and age of all baseball players. It is available as a 2D numpy array, updated. Add np_baseball and updated and print out the result.
...
print("Median height of goalkeepers: " + str(np.median(np_heights[np_positions=='GK'])))

# Print out the median height of other players. Replace 'None'
print("Median height of other players: " + str(np.median(np_heights[np_positions !='GK'])))
